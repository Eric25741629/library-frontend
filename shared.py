...
def init_box_db():
    ...
    try:
        ...
        if 'reservation_acknowledged_at' not in cols:
            c.execute('ALTER TABLE box_inventory ADD COLUMN reservation_acknowledged_at TEXT')
        ...
        if 'reservation_acknowledged_at' not in cols_h:
            c.execute('ALTER TABLE box_history ADD COLUMN reservation_acknowledged_at TEXT')
